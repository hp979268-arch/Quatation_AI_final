...
for code, group in grouped.items():
    # Sort ascending by price! The lowest price is the seat cover alone.
    group.sort(key=lambda x: float(x.get('price', 0)))
...
print(f'Removed {removed} wrong higher-priced bidet entries.')
